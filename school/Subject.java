...
public class Subject {
    ...
    public void addSubjectScore(Student student){ studentList.add(student);}
    ...
    public void setGetStudentList(ArrayList<Student> studentList){ this.studentList = studentList; }
